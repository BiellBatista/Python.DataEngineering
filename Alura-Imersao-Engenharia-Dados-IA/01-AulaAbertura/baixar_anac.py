...
REFERENCIAS = {
    ...
    # com 646 empresas reais multiplicadas em ~461 mil linhas. Ver PERRENGUES.md (P2.1).
...
def main() -> None:
    ...
    linhas += [
        ...
        "  exatamente o mesmo schema do arquivo de estrangeiras. Ver `PERRENGUES.md` P2.1.",
    ]
